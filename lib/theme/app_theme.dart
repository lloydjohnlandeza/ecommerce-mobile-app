import 'package:ecommerce_mobile_app/theme/app_colors_extension.dart';
import 'package:ecommerce_mobile_app/theme/app_palette.dart';
import 'package:ecommerce_mobile_app/theme/app_text_theme_extension.dart';
...
class AppTheme with ChangeNotifier {
  ...
  static final _lightAppColors = AppColorsExtension(
    primary: AppPalette.crimsonRed,
    onPrimary: Colors.white,
    secondary: Colors.black,
    onSecondary: Colors.white,
    error: AppPalette.brightRed,
